...
python3 trainTest.py --expNumber 882 --total_timesteps 33000000 --n_steps 1000 --batch_size 2048 --n_envs 100 --testSamples 1 --evalFreqOnTraining 3000000 --lambdaErr 100.0 --velocityConstant 0.1 --orientationConstant 50 --maeThreshold 0.05 --configName "3.yaml" --avgJntVelThreshold 0.15
